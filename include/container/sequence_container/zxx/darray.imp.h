...
template <typename T, typename Allocator>
darray<T, Allocator>::darray(size_type n,
...
darray<T, Allocator>::darray(InputIterator first,
                                               InputIterator last,
                                               const Allocator &alloc) {}

template <typename T, typename Allocator>
darray<T, Allocator>::darray(std::initializer_list<T> init,
                                               const Allocator &alloc) {}
...
template <typename T, typename Allocator>
template <class... Args>
void darray<T, Allocator>::emplace_back(Args &&... args) {
  return;
}
...
template <typename T, typename Allocator>
void darray<T, Allocator>::push_back(const T &x) {
  return;
}

template <typename T, typename Allocator>
void darray<T, Allocator>::push_back(T &&x) {
  return;
}
...
template <typename T, typename Allocator>
void darray<T, Allocator>::clear() {
  return;
}

template <typename T, typename Allocator>
void darray<T, Allocator>::swap(darray &darr) {
  return;
}
...
template <typename T, typename Allocator>
bool darray<T, Allocator>::empty() const noexcept {
  return false;
}

template <typename T, typename Allocator>
void darray<T, Allocator>::reserve(size_type n) {
  return;
}

template <typename T, typename Allocator>
void darray<T, Allocator>::shrink_to_fit() {
  return;
}
