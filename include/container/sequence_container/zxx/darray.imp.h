...
constexpr darray<T, Allocator>::darray(const Allocator &alloc) {}

template <typename T, typename Allocator>
constexpr darray<T, Allocator>::darray(const darray &other) {}
...
template <typename T, typename Allocator>
constexpr darray<T, Allocator>::darray(darray &&other) {}
...
template <typename T, typename Allocator>
constexpr darray<T, Allocator>::darray(size_type n,
...
constexpr darray<T, Allocator>::darray(InputIterator first,
                                               InputIterator last,
                                               const Allocator &alloc) {}

template <typename T, typename Allocator>
constexpr darray<T, Allocator>::darray(std::initializer_list<T> init,
                                               const Allocator &alloc) {}

template <typename T, typename Allocator> darray<T, Allocator>::~darray() {}

template <typename T, typename Allocator>
constexpr darray<T, Allocator> &
...
template <typename T, typename Allocator>
constexpr typename darray<T, Allocator>::iterator
darray<T, Allocator>::begin() {
  return typename darray<T, Allocator>::iterator();
}

template <typename T, typename Allocator>
constexpr typename darray<T, Allocator>::const_iterator
...
template <typename T, typename Allocator>
constexpr typename darray<T, Allocator>::reverse_iterator
darray<T, Allocator>::rbegin() {
  return typename darray<T, Allocator>::reverse_iterator();
}

template <typename T, typename Allocator>
constexpr typename darray<T, Allocator>::const_reverse_iterator
...
template <typename T, typename Allocator>
constexpr typename darray<T, Allocator>::reference
...
template <typename T, typename Allocator>
constexpr typename darray<T, Allocator>::const_reference
...
template <typename T, typename Allocator>
template <class... Args>
constexpr void darray<T, Allocator>::emplace_back(Args &&... args) {
  return;
}
...
template <typename T, typename Allocator>
constexpr void darray<T, Allocator>::push_back(const T &x) {
  return;
}

template <typename T, typename Allocator>
constexpr void darray<T, Allocator>::push_back(T &&x) {
  return;
}

template <typename T, typename Allocator>
constexpr void darray<T, Allocator>::pop_back() {
  return;
}
...
template <typename T, typename Allocator>
constexpr void darray<T, Allocator>::clear() {
  return;
}

template <typename T, typename Allocator>
constexpr void darray<T, Allocator>::swap(darray &darr) {
  return;
}

template <typename T, typename Allocator>
constexpr typename darray<T, Allocator>::size_type
...
template <typename T, typename Allocator>
constexpr bool darray<T, Allocator>::empty() const noexcept {
  return false;
}

template <typename T, typename Allocator>
constexpr void darray<T, Allocator>::reserve(size_type n) {
  return;
}

template <typename T, typename Allocator>
constexpr void darray<T, Allocator>::shrink_to_fit() {
  return;
}

template <typename T, typename Allocator>
constexpr typename darray<T, Allocator>::allocator_type
